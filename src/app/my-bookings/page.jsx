...
export default function MyBookingsPage() {
  ...
  useEffect(() => {
    async function fetchBookings() {
      ...
      console.log("DEBUG: Email from storage:", userEmail);
      ...
      try {
        ...
        console.log("DEBUG: API Response Raw Data:", json); 

        // CRITICAL FIX: Direct array assignment matching your backend configuration
        if (json && Array.isArray(json)) {
          ...
          console.log("Data format mismatch, setting fallback empty array.");
          setBookings([]);
        }
      } catch (err) {
